...
//die();
// IGNORE THIS CODE FOR NOW, IT START's GETTING COMPLICATED
// remember that if the url is http://localhost/web-dev/code-samples/php/url-rewriting/
// then $page will be an empty string, but we'll need to show the index page
if(empty($path)){
	$path = "index.html";
}
